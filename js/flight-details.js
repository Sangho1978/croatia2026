(function(){
 ...
 function header(leg){return `<div class="flight-head"><b>${leg.airline?leg.airline+' ':''}${leg.flight} · ${leg.origin} → ${leg.destination}</b><span>09/22 안내소책자 기준 · 최종 E-ticket 우선</span></div>`;}
 function card(leg){const f=FlightPlan,out=leg===f.out;
   ...
   const content=out?'티웨이항공 TW405 로마 도착 19:15. 입국 수속과 짐 수령 후 Terminal 1 라이언에어(Ryanair) 카운터로 이동(소책자 도보 약 10분)하여 라이언에어 FR5975로 연결합니다.':'자그레브 관광·자유시간·석식 후 공항으로 이동하여 라이언에어 FR8836 탑승. 로마 도착 후 Ergife Palace Hotel로 이동해 투숙합니다.';
